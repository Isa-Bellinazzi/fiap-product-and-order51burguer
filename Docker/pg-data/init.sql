...
CREATE TABLE "order" (id integer primary key generated by default as identity, date_created timestamp(6) DEFAULT NULL, status status_enum NOT NULL, time_waiting_order int NOT NULL, total_price DOUBLE PRECISION NOT NULL, client_id int DEFAULT NULL);
